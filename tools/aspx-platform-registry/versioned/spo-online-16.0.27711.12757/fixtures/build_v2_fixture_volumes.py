#!/usr/bin/env python3
"""Build deterministic synthetic Assessment v2 consumer fixtures for CCD-869."""
...
def build_physical_store() -> tuple[bytes, str]:
    ...
    try:
        ...
        manifest.update(
            ...
            sdkRef=SDK_REF,
            fixtureRevision="ccd-869-assessment-v2-r1",
        )
...
def reference_documents() -> tuple[dict[str, object], dict[str, object], dict[str, object]]:
    ...
    pagination = {
        ...
        "attemptCount": 1,
        "attemptLimit": 1,
        "authorityRevision": "ccd-834-fixture-authority-v1",
...
def main() -> None:
    ...
    reader_template = {
        ...
        "platformBuild": BUILD,
        "registryEnvelope": {
            "authorityArtifactHash": "8394ef9d5f1e6409131835ab123a5104afa5cedc17b65580831ebc7eee81e9d5",
            "authoritySourceRef": "0ff1276087a43640144d8072fa347a886473855f",
            "platformBuild": BUILD,
            "platformFamily": "SharePointOnline-16",
            "profileHash": "c4a4892fa269484f0badd4fa24364161e8cd9cb0b8bdeac3eebd7b49fb51f51e",
            "profileRevision": "spo-online-16.0.27711.12757-profile-r1",
            "profileSchemaVersion": "aspx-platform-registry-profile/v2",
            "registryHash": REGISTRY_HASH,
            "registryRevision": REGISTRY_REVISION,
            "registrySchemaHash": "3ca69e123d826c4273c86b460a33f6d391455449c745e8b9b2455d7db0c9f4e9",
    ...
    fixtures = {
        ...
        "fixtureProvenance": {
            ...
            "baselineReview": "CCD-745+CCD-755+CCD-756+CCD-834+CCD-845+CCD-869",
