...
namespace System.Linq
{
    internal static class NetStandardLinqExtensions
    {
        ...
        public static Collections.Generic.HashSet<T> ToHashSet<T>(this Collections.Generic.IEnumerable<T> source, Collections.Generic.IEqualityComparer<T> comparer)
        {
