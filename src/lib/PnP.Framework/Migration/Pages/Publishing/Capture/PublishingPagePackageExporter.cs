    ...
    internal sealed class PublishingPagePackageExporter
    {
            ...
            IMigrationArtifactStore artifactStore)
        {
            ...
            try
            {
                ...
                {
                    warnings.Add("Source Web ancestor fidelity is authorization-blocked, but exact source and target-relative path planning remains available through shared topology ingredients.");
                }
            }
