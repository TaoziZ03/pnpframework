...
namespace PnP.Framework.Migration.Pages.Publishing.Article
{
    public static class ArticlePagePackageFileStore
    {
        ...
        {
            var exportPath = ResolveExistingPath(path, DefaultExportFileName, "Article Page export");
        ...
        {
            var assessmentPath = ResolveExistingPath(path, DefaultAssessmentFileName, "Article Page assessment");
        ...
        {
            var packagePath = ResolveExistingPath(path, DefaultPackageFileName, "Article Page migration package");
