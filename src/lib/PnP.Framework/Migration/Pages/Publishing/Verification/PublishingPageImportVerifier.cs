...
{taxCatchAllViewField}
  ...
  <RowLimit>1</RowLimit>
                ...
                var topologyMatched = TopologyMatched(package, executionScope, topologyReceipt, sharedTopologyReceipt);
        ...
        {
            return package.Plan.SharedTopologyReference?.SourceFidelityState
