...
namespace PnP.Framework.Migration.Pages.Publishing.Comparison
{
    public static class PublishingPageCompareContract
    {
        ...
        public const string RuntimeManifestSchemaVersionV2 = "pnp-migration-runtime-verification/v2";
        ...
        public static class ReasonCodes
        {
            ...
            public const string SourceVersionUnknown = "source.version.unknown";
            public const string TargetEvidenceUnknown = "target.evidence.unknown";
            public const string TargetEvidencePartial = "target.evidence.partial";
            public const string TargetEvidenceMissing = "target.evidence.missing";
            public const string TargetEvidenceDenied = "target.evidence.denied";
            public const string TargetEvidenceExpired = "target.evidence.expired";
            public const string RuntimeRequirementFailed = "runtime.requirement.failed";
        }
    }

    public static class IngredientTargetEvidenceStates
    {
    ...
    public sealed class IngredientCompareResult
    {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public string TargetEvidenceState { get; set; }

        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public DateTimeOffset? ObservedAtUtc { get; set; }

        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public IList<string> RuntimeRequirementIds { get; set; }
    ...
    public sealed class RuntimeAssertionCompareResult
    {
        ...
        public IList<string> AttachedActionIds { get; set; } = new List<string>();
    ...
    public sealed class IngredientCompareLineage
    {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public string TargetEvidenceDigestSha256 { get; set; }
