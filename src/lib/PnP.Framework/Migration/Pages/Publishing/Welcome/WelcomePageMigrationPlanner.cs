...
namespace PnP.Framework.Migration.Pages.Publishing.Welcome
{
    public sealed class WelcomePageMigrationPlanner
    {
        ...
        public PublishingPageMigrationPackage Plan(
            ...
            PagePlanningOptions options)
        {
            return planner.Plan(targetContext, exportPackage, options, WelcomePageV1WorkflowPolicy.Instance);
        }
        ...
        public PublishingPageMigrationPackage Plan(
            ...
            IMigrationArtifactStore artifactStore)
        {
            return planner.Plan(targetContext, exportPackage, options, WelcomePageV1WorkflowPolicy.Instance, artifactStore);
        }
    }
}
