...
namespace PnP.Framework.Migration.Pages.Publishing.Welcome
{
    public static class WelcomePagePackageFileStore
    {
        ...
        {
            var exportPath = ResolveExistingPath(path, DefaultExportFileName, "Welcome Page export");
        ...
        {
            var assessmentPath = ResolveExistingPath(path, DefaultAssessmentFileName, "Welcome Page assessment");
        ...
        {
            var packagePath = ResolveExistingPath(path, DefaultPackageFileName, "Welcome Page migration package");
