...
namespace PnP.Framework.Migration.Pages.Assessment.Maturity
{
    ...
    internal sealed class IngredientOperationalEvidence
    {
        ...
        public AdmittedReproExecutionPlan AdmittedExecutionPlan { get; set; }

        public string AdmittedExecutionPlanDigestSha256 { get; set; }

        public IMigrationArtifactStore RuntimeArtifactStore { get; set; }
