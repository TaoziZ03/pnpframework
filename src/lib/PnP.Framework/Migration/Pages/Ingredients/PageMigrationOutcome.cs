namespace PnP.Framework.Migration.Pages.Ingredients
{
    public enum PageMigrationOutcome
    {
        ...
        /// <summary>
        /// The executable plan contains one or more policy-approved evidence-only
        /// or expected-absent ingredients. It must not be reported as exact.
        /// </summary>
        ExecutableWithApprovedExclusions = 9
    }
}
