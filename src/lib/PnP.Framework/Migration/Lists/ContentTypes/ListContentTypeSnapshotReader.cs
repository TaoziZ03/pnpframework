...
namespace PnP.Framework.Migration.Lists.ContentTypes
{
    internal static class ListContentTypeSnapshotReader
    {
        ...
        {
            return contentTypes.AsEnumerable()
                .Select(contentType => ReadOne(contentType, diagnostics))
                .OrderBy(value => value.Id, StringComparer.OrdinalIgnoreCase)
                .ToList();
        }

        internal static ListContentTypeSnapshot ReadOne(
        ...
        internal static ListContentTypeSnapshot Partial(ContentType contentType)
        {
            return new ListContentTypeSnapshot
            {
                Id = contentType.Id.StringValue,
                ...
                Availability = PnP.Framework.Migration.Evidence.EvidenceAvailability.Partial
            };
        }
