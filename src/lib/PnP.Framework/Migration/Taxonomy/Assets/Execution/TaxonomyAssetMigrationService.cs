    ...
    public sealed class TaxonomyAssetMigrationService
    {
            ...
            IMigrationExecutionJournal journal = null)
        {
            ...
            var boundary = MigrationExecutionBoundary.Create(
                reviewedPlan.SourceSnapshotDigest,
                reviewedPlan.PlanDigest,
                approval.ApprovalDigest,
                "taxonomy-term-store:" + reviewedPlan.TargetTermStoreId.ToString("D"));
            var recorder = new MigrationExecutionRecorder(operationId, boundary, journal);
