        ...
        public SharedTopologyPlanBuildResult Build(PathDerivedTopologyPlanningRequest request)
        {
            ...
            foreach (var segment in sourceSegments)
            {
                ...
                var container = new TargetWebContainerIngredientPlan
                {
                    ...
                    AllowReuseExistingExactPath = request.ProvisioningPolicy.AllowReuseExistingExactPath,
                ...
                container.IngredientDigest = SharedTopologyDigest.ComputeContainer(container);
